...
public class CommandUnblacklist extends Command {
    ...
    public void execute(Message msg, String alias, String[] args) {
        ...
        embedBuilder.setTitle(args[0] + " has been removed from the blacklist!");
        embedBuilder.setDescription("Unblacklisted by: " + msg.getAuthor() +
    ...
    public EmbedBuilder getInfo() {
        ...
        EmbedBuilder embedBuilder = new EmbedBuilder();
        embedBuilder.setTitle("Command: Unblacklist");
        embedBuilder.addField("Required rank", "Owner", false);
        embedBuilder.addField("Syntax", "-alias [realmeye name]", false);
        embedBuilder.addField("Aliases", aliases, false);
        embedBuilder.addField("Information", "Unblacklists a realmeye name, allowing them to re-verify", false);
        return embedBuilder;
}
}
